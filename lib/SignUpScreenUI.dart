...
import 'package:signin_signup_ui/SignInScreenUI.dart';
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                            ...
                            /// textFormField of Confirm Password
                            customTextField(
                                ...
                                suffixIcon: GestureDetector(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.all(10.sp),
                                      child: Image.asset(
                                        isShowConfirmPassword ? "icons/ic_passwordShow.png" : "icons/ic_passwordHide.png",
                                        color: MyAppColor.primaryBorderGreyColor,
                                      ),
                                    ))),
                            SizedBox(height: 40.h),
                            ...
                            Text.rich(TextSpan(children: [
                              TextSpan(text: "Have an account? ",style: TextStyle(fontSize: 13.sp, fontFamily: "Medium", fontWeight: FontWeight.w600, color: MyAppColor.primaryGreyColor.withOpacity(0.5)),),
                              TextSpan(text: "Sign in",style: TextStyle(fontSize: 13.sp, fontFamily: "SemiBold", fontWeight: FontWeight.w700, color: MyAppColor.primaryBlueColor),recognizer: TapGestureRecognizer()
                                ..onTap = () {
                                  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => const SignInScreenUI()),(route) => false);
                                },
                              )
                            ])),
                          ],
